...
### CloudFormation Stack Sets (Organization)
...
6. Enter `pDataPortalAccountId`, `pAccountOwner` can be left blank in a typical organization setup.
...
### CloudFormation (Individual Account)

You can manually deploy the CloudFormation template through the UI.
...
You can also manually launch the wizard and upload the template .yml file or use our [S3 mirror](#s3-mirror).
